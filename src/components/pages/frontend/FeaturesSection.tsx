  ...
  const features = [
    {
      ...
      icon: (
        <svg
          className="shrink-0 mt-2 size-6 md:size-7 hs-tab-active:text-[#B33F40] text-muted-800 dark:hs-tab-active:text-[#B33F40] dark:text-muted-200"
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      <span className="block text-lg font-semibold hs-tab-active:text-[#B33F40] text-muted-800 dark:hs-tab-active:text-[#B33F40] dark:text-muted-200">
                        {feature.title}
                      </span>
