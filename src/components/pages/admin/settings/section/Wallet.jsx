...
const walletFields = [
    {
        ...
        description: "Spot wallet deposit expiration limit to prevent lookups from use random transactions that sent to the spot wallet address",
        type: "switch",
    },
    {
...
const WalletSection = ({ formData, handleInputChange, handleCancel, handleSave, hasChanges, isLoading, }) => {
      ...
      <div className="col-span-12 lg:col-span-7 ltablet:col-span-7">
        <div className="lg:max-w-xl">
          <div className="grid w-full grid-cols-12 gap-x-6 gap-y-4">
            {walletFields.map((field) => (0, RenderField_1.default)({ field, formData, handleInputChange }))}
