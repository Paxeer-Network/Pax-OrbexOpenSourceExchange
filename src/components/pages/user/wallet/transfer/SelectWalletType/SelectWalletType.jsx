...
const SelectWalletTypeBase = ({}) => {
    ...
    const { walletTypes, selectedWalletType, setSelectedWalletType, setStep, transferType, setSelectedTargetWalletType, fetchCurrencies, } = (0, transfer_1.useTransferStore)();
    const handleContinue = () => {
        if (transferType.value === "client") {
            setSelectedTargetWalletType(selectedWalletType);
            fetchCurrencies();
            setStep(4);
        }
        else {
      ...
      <div className="mx-auto mb-4 w-full max-w-lg rounded-sm px-8 pb-8">
        ...
        <div className="mx-auto mt-8! max-w-sm">
          <div className="flex w-full gap-4 justify-center">
            ...
            <Button_1.default type="button" color="primary" size="lg" className="w-full" onClick={handleContinue} disabled={selectedWalletType.value === ""}>
              {t("Continue")}
