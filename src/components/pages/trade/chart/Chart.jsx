...
const ChartBase = ({}) => {
    ...
    if (isMobile) {
        ...
        const mobileEnabledFeatures = enabled_features.filter(feature => feature !== "left_toolbar" && feature !== "control_bar");
                ...
                setTimeout(() => {
                    callback({
                        ...
                        supported_resolutions: isEco
                            ? chart_1.intervals
                            : chart_1.supported_resolutions_provider[provider || "binance"],
                    });
                }, 0);
            },
                ...
                try {
                    ...
                    const response = await (0, api_1.default)({
                        ...
                        params: {
                            ...
                            interval: chart_1.resolutionMap_provider[provider || "binance"][resolution],
                            from: from,
                            to: to,
                            duration: duration,
                        },
    ...
    async function initTradingView() {
        ...
        try {
            ...
            if (isMobile) {
                ...
                setTimeout(() => {
                    try {
                        if (tv && typeof tv.resize === 'function' && typeof window !== 'undefined') {
                            tv.resize(window.innerWidth, window.innerHeight * 0.7);
                        }
                    }
                    catch (e) {
    ...
    return (<div className={`w-full h-full bg-white dark:bg-zinc-950 rounded-lg overflow-hidden ${isMobile ? 'min-h-[400px]' : ''}`}>
      <div id="tv_chart_container" className="w-full h-full" style={{
