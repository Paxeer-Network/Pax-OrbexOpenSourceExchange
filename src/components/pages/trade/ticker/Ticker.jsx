...
const market_2 = __importDefault(require("@/stores/trade/market"));
...
const TickerBase = () => {
    ...
    (0, react_1.useEffect)(() => {
        if (router.isReady && market) {
            ...
            const handleXtTickerMessage = (message) => {
                if (message.stream !== "ticker")
                    return;
                const { data } = message;
                if (!data || data.symbol !== market.symbol)
            ...
            if (connection === null || connection === void 0 ? void 0 : connection.isConnected) {
                ...
                subscribe(connectionKey, "ticker", { symbol: market === null || market === void 0 ? void 0 : market.symbol });
            }
            return () => {
                if (connection === null || connection === void 0 ? void 0 : connection.isConnected) {
                    unsubscribe(connectionKey, "ticker", { symbol: market === null || market === void 0 ? void 0 : market.symbol });
      ...
      <div className="flex w-full h-full">
        <div className="w-1/3 flex flex-col md:flex-row items-center h-full gap-1">
          ...
          {process.env.NEXT_PUBLIC_EXCHANGE &&
            ["bin", "xt"].includes(process.env.NEXT_PUBLIC_EXCHANGE) && (<div className="w-full md:w-1/2 text-xs md:text-sm">
        ...
        {process.env.NEXT_PUBLIC_EXCHANGE &&
            ["bin", "xt"].includes(process.env.NEXT_PUBLIC_EXCHANGE) && (<>
              ...
              <div className="w-1/3 flex flex-col md:flex-row text-xs md:text-sm h-full items-center justify-between">
                {process.env.NEXT_PUBLIC_EXCHANGE === "bin" && (<div className="w-full md:w-1/2">
                    <span className="text-muted-600 dark:text-muted-400">
                      {t("24h volume")} ({market === null || market === void 0 ? void 0 : market.currency})
                    </span>
                    <div>
                      {(ticker === null || ticker === void 0 ? void 0 : ticker.baseVolume) ? ((0, market_1.formatLargeNumber)(ticker.baseVolume, getPrecision("amount"))) : (<react_loading_skeleton_1.default width={40} height={10} baseColor={clientIsDark ? "#27272a" : "#f7fafc"} highlightColor={clientIsDark ? "#3a3a3e" : "#edf2f7"}/>)}
                    </div>
                  </div>)}
                <div className="w-full md:w-1/2">
                  <span className="text-muted-600 dark:text-muted-400">
                  ...
                  <div>
                    {(ticker === null || ticker === void 0 ? void 0 : ticker.quoteVolume) ? ((0, market_1.formatLargeNumber)(ticker.quoteVolume, getPrecision("price"))) : (<react_loading_skeleton_1.default width={40} height={10} baseColor={clientIsDark ? "#27272a" : "#f7fafc"} highlightColor={clientIsDark ? "#3a3a3e" : "#edf2f7"}/>)}
                  </div>
                </div>
              </div>
            </>)}
        {process.env.NEXT_PUBLIC_EXCHANGE === "kuc" && (<>
            <div className="w-1/2 flex flex-col md:flex-row text-xs md:text-sm h-full items-center justify-between">
              <div className="w-full md:w-1/2">
                ...
                <div>
                  {((_d = ticker === null || ticker === void 0 ? void 0 : ticker.bid) === null || _d === void 0 ? void 0 : _d.toFixed(5)) || (<react_loading_skeleton_1.default width={40} height={10} baseColor={clientIsDark ? "#27272a" : "#f7fafc"} highlightColor={clientIsDark ? "#3a3a3e" : "#edf2f7"}/>)}
                </div>
              </div>
              <div className="w-full md:w-1/2">
                <span className="text-muted-600 dark:text-muted-400">
                ...
                <div>
                  {((_e = ticker === null || ticker === void 0 ? void 0 : ticker.ask) === null || _e === void 0 ? void 0 : _e.toFixed(5)) || (<react_loading_skeleton_1.default width={40} height={10} baseColor={clientIsDark ? "#27272a" : "#f7fafc"} highlightColor={clientIsDark ? "#3a3a3e" : "#edf2f7"}/>)}
                </div>
              </div>
            </div>
            <div className="w-1/2 flex flex-col md:flex-row text-xs md:text-sm h-full items-center justify-between">
              <div className="w-full md:w-1/2">
                ...
                <div>
                  {((_f = ticker === null || ticker === void 0 ? void 0 : ticker.close) === null || _f === void 0 ? void 0 : _f.toFixed(5)) || (<react_loading_skeleton_1.default width={40} height={10} baseColor={clientIsDark ? "#27272a" : "#f7fafc"} highlightColor={clientIsDark ? "#3a3a3e" : "#edf2f7"}/>)}
                </div>
              </div>
              <div className="w-full md:w-1/2">
                <span className="text-muted-600 dark:text-muted-400">
                ...
                <div>
                  {((_g = ticker === null || ticker === void 0 ? void 0 : ticker.last) === null || _g === void 0 ? void 0 : _g.toFixed(5)) || (<react_loading_skeleton_1.default width={40} height={10} baseColor={clientIsDark ? "#27272a" : "#f7fafc"} highlightColor={clientIsDark ? "#3a3a3e" : "#edf2f7"}/>)}
                </div>
              </div>
            </div>
          </>)}
