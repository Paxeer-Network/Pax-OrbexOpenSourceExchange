        ...
        <div className="p-4 md:px-6">
          <div className="mt-4 mb-4">
            ...
            label: (0, text_1.capitalize)(type),
                ...
                {type === "url" && (<Input_1.default type="text" shape="rounded-sm" label="URL" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 mb-4" placeholder="Eg. https://paxeer.app/user" defaultValue={url} onChange={(e) => setUrl(e.target.value)}/>)}
