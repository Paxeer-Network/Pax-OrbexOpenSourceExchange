...
} from "../../../../ext/ecosystem/wallet/utils";
...
export const metadata: OperationObject = {
  summary: "Fetches a specific SPOT wallet by currency",
  description:
    "Retrieves details of a SPOT wallet associated with the logged-in user by its currency.",
  operationId: "getSpotWallet",
  tags: ["Wallet", "User", "SPOT"],
  requiresAuth: true,
  parameters: [
    {
      index: 0,
  ...
  responses: {
    200: {
      description: "SPOT Wallet retrieved successfully",
      content: {
        "application/json": {
          schema: {
            type: "object",
    ...
    404: notFoundMetadataResponse("SPOT Wallet"),
...
export default async (data: Handler) => {
  ...
  // Get or create SPOT wallet (auto-creation like ECO system)
  const wallet = await getSpotWalletByUserIdAndCurrency(user.id, currency);
...
async function getActiveCustodialWallets(
  ...
  return models.ecosystemCustodialWallet.findAll({
